  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-xl font-semibold text-gray-800 dark:text-white/90">Kitob alifbosini qo'shish</h3>
      </div>
      
      <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-6 mb-8 mt-15">
        <div className="w-full md:col-span-2">
          <label htmlFor="alphabet" className="block font-medium text-gray-700 dark:text-gray-300 mb-2">
            Kitob alifbosi
          </label>
          <input
            id="alphabet"
      ...
      <div className="space-y-6">
        ...
        {fetchLoading ? (
          ...
          <div className="text-center py-12">
            <Type className="w-12 h-12 text-gray-300 dark:text-gray-600 mx-auto mb-4" />
